...
awk -F '\t' '$24 == "Spumellaria" { print $1}' "data/fig2_sanger.tsv" > "data/sanger/blast/polycystines_reads.list"
awk -F '\t' '$24 == "Nassellaria" { print $1}' "data/fig2_sanger.tsv" >> "data/sanger/blast/polycystines_reads.list"

sequenceSelect.py -f ${OUTPUT} -o "data/sanger/raw/polycystines_V4.fasta" -l "data/sanger/blast/polycystines_reads.list" -a k
...
# Select only Polycystine (Nassellaria and Spumellaria) reads
awk -F '\t' '$24 == "Spumellaria" { print $21"_"$22"_"$1}' "data/fig2_minion.tsv" > "data/minion/blast/polycystines_reads.list"
awk -F '\t' '$24 == "Nassellaria" { print $21"_"$22"_"$1}' "data/fig2_minion.tsv" >> "data/minion/blast/polycystines_reads.list"

sequenceSelect.py -f ${OUTPUT} -o "data/minion/raw/polycystines_V4.fasta" -l "data/minion/blast/polycystines_reads.list" -a k
